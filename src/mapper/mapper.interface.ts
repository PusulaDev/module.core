export type IMapper<Source, Target> = {
    setTargetConfig(config: Omit<MapperConfiguration<Source, Target>, "fieldConfigurations">): void;

    setSourceConfig(config: Omit<MapperConfiguration<Target, Source>, "fieldConfigurations">): void;
...
export type MapperFieldConfigurations<Source, Target> = {
    [TargetField in keyof Target]?: keyof Source | MapperFunc<Source, Target, TargetField>;
} & unknown;
...
export type MapperTargetValue<Source, Target, TargetField extends keyof Target> =
    | keyof Source
